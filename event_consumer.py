...
exchange_log = Exchange("amq.rabbitmq.event", type="topic", durable=True)
queue_log = Queue("q-log", exchange=exchange_log, durable=True, routing_key="connection.#")
...
out_file="/home/adaas/adaas_demo/q-event" + str(datetime.now()).replace(" ","_")
run()
