...
rabbit_url = "amqp://cons2:password2@134.221.121.65:5670/vhost1" #proxy
...
#out_file="/home/adaas/adaas_demo/logs-selector/q-top-2-" + str(datetime.now()).replace(" ","_")
#out_file_log="/home/adaas/adaas_demo/logs-selector/log-q-top-2-" + str(datetime.now()).replace(" ","_")

out_fname="/home/adaas/adaas_demo/logs-selector/out_fname2.txt"
